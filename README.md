...
### Descripcion
Este es un proyecto creado con react, basado en un buscador de bebidas, en el cual hay campo de busqueda al buscar, hace una llamada a la api,
y muestra la informacion en un modal.
Se utiliza context. 

### Instalación 🔧
1-Crear una carpeta donde desea clonar el proyecto
2-Abrir una consola de comando y ubicarse en la carpeta anteriormente creada luego clone el proyecto con el comado git clone https://github.com/brian-dg/Buscador-de-bebidas
...
Link:https://buscador-coctel.netlify.app
